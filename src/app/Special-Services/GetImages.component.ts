...
ngOnInit(){
  ...
  if (this.i<this.ConfigXMV.UserSpecific.length){
    this.myLogConsole=this.ConfigXMV.UserSpecific[this.i].log;
      ...
      this.bucketMgt.Max_Nb_Bucket_Wedding=1;
          ...
          this.LogMsgConsole('===== bucket - all buckets processed; fill-in now WeddingPhotos ');
            ...
            for (this.bucketMgt.i_Bucket=i; this.bucketMgt.i_Bucket<=this.bucketMgt.Max_Nb_Bucket_Wedding;  this.bucketMgt.i_Bucket++){
              this.bucketMgt.Nb_Buckets_processed++;
                ...
                for (this.i=0; this.i<this.Tab_NameListPhotos.length; this.i++ ){
                      this.fillFromBucket();
...
fillFromBucket(){
  ...
  this.WeddingPhotos[this.j].name=this.Tab_NameListPhotos[this.i];
  this.WeddingPhotos[this.j].mediaLink=Assets+this.Tab_NameListPhotos[this.i];;
  this.WeddingPhotos[this.j].selfLink=Assets+this.Tab_NameListPhotos[this.i];;
  this.WeddingPhotos[this.j].photo.src=Assets+this.Tab_NameListPhotos[this.i];;
/**
 ...
 */
  ...
  if (this.WeddingPhotos[this.j].name.indexOf('Vertical')!==-1){
